...
class LocalAdapter(BaseAdapter):
    ...
    def store(r_id):
        ...
        current_location = "{}/{}".format(self.dropbox_dir,
                                          dropbox_path)
        new_location = "{}/{}".format(
           self.storage_dir, dropbox_path)
        ...
        other_copies = self.cursor.execute("select * from copies where resource_id=? and adapter_id=? limit 1", r_id, self.adapter_id)
